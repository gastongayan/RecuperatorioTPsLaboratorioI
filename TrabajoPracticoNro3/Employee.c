...
int employee_requestData(char nombre[], int* horasTrabajadas, int* sueldo){
	int rtn=0;
//validar
	if(CargarUnaCadena("Ingrese nombre del empleado:\n", nombre) &&
	!CargarUnEntero("Ingrese cantidad de horas trabajadas:\n",horasTrabajadas,0,1000) &&
	!CargarUnEntero("Ingrese sueldo percibido:\n", sueldo, 0, 999999)){
		rtn = 1;
	}
